...
<body>
	...
	<div class="container-fluid">
      	<div class="row-fluid">
			...
			<li><a href="adminServlet?action=findAllUsers" target="iframe">查看企业用户</a></li>
					<li><a href="adminServlet?action=findAllgover" target="iframe">查看政府用户</a></li>
						  <li><a href="adminServlet?action=findUser" target="iframe">查找企业（发布对企业的建议）</a></li>
						<li><a href="GlyServlet?action=modifyUser1" target="iframe">修改密码</a></li>
						<li><a href="adminServlet?action=addUser" target="iframe">添加账号</a></li>
				<li><a href="home.jsp" >返回主页面</a></li>
		            </ul>
          		</div>
        	</div><!--/span-->
