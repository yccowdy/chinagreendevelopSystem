...
<div class="listlb" style="height:660px">
	...
	<center><h1>关于免费使用企业绿色评价系统的通知</h1></center>
	<br />
	&nbsp;&nbsp;&nbsp;<h4>企业绿色发展是社会经济可持续发展的客观要求，也是打造企业竞争优势的重要途径，
	客观评价企业绿色行为对于企业提升自身绿色管理水平具有重要意义。中国企业绿色行为评价系统是国家自然科学基金项目资助的公益性网站，
	主要功能是宣传企业绿色发展理念，展示企业绿色实践成果，评价企业绿色发展水平，服务企业绿色转型发展。目前该评价系统开发了水泥工业、煤炭采选业、非金属矿物制品业（平板玻璃）、非金属矿物制品业（人造板）、
	氮肥制造业等5个行业评价标准。该5个行业的企业在网上注册后可以进行自我评价并打印输出企业绿色行为自我评价报告。
	</h4>
	</div>	
    <div id="right" style="height:690px; display:table">
		<div class='title' style="height:200px" ><h4><a class="left" target="_blank">通知公告</a><!-- &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;<a href="/c/wjtz/" style="color:#000; font-size:12px"></a></h3>
		 --></h4>
		 <br /><ul>
	...
	<div class='title' style="height:150px">
	  ...
	  <h3 class="h3title" ><img src="lc.png" border="0" align="absmiddle" style="margin:0 0 0 -73px;" /><a href="绿色评价—企业绿色评价—流程（正在写）.docx" target="_blank">评价流程</a></h3>
		...
		<ul>
		<li>·<a href="1.jsp">太原钢铁：绿色发展实践</a></li>
		
		<li>·<a href="2.jsp">海尔绿帆&nbsp;：向环保航行</a></li>
		<br/>
		<li>·<a href="3.jsp">兴发化工&nbsp;实现减排节能与环境保护的双赢</a></li>
		<br/>
		<li>·<a href="4.jsp">湖北洋丰,“绿色洋丰”环保新招数</a></li><br/>
		<li>·<a href="5.jsp">华新水泥,美好的世界，从我们开始</a></li>
		<br/>
		<li>·<a href="6.jsp">神华集团,建设世界一流的清洁能源供应商</a></li>
...
<strong>[相关链接]</strong>
    <a href="http://www.zhb.gov.cn/">国家环保局</a>|<a href="http://gsxt.saic.gov.cn/">国家企业信息公示系统</a>|<a href="http://www.creditchina.gov.cn/" >信用中国</a>|<a href="http://www.sdpc.gov.cn/" >国家发改委</a> | <a href="/c/dljgcx/" >湖北省环保厅</a> | <a href="http://www.sasac.gov.cn/" >国务院国资委</a> |<a href="http://www.stats.gov.cn/"> 国家统计局</a><a href="/c/tjqy/zfbm/245.html" ></a></p>
</div>
